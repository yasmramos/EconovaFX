...
import com.econovafx.modules.accounting.repository.ClosingEntryRepository$DI;
...
import com.econovafx.modules.accounting.service.ExchangeRevaluationService$DI;
import com.econovafx.modules.accounting.service.FinancialStatementService$DI;
import com.econovafx.modules.accounting.service.IntercompanyEliminationService$DI;
import com.econovafx.modules.accounting.service.OpeningBalanceService$DI;
import com.econovafx.modules.accounting.service.TransactionService$DI;
import com.econovafx.modules.bank.repository.BankAccountRepository$DI;
import com.econovafx.modules.bank.repository.BankReconciliationRepository$DI;
...
import com.econovafx.modules.cash.controller.CashBankController$DI;
import com.econovafx.modules.cash.controller.CashModuleController$DI;
import com.econovafx.modules.cash.repository.CashBoxRepository$DI;
import com.econovafx.modules.cash.repository.CashMovementRepository$DI;
import com.econovafx.modules.cash.service.CashMovementService$DI;
import com.econovafx.modules.core.config.AppConfig$DI;
import com.econovafx.modules.core.config.DataInitializer$DI;
import com.econovafx.modules.core.config.DatabaseConfig$DI;
import com.econovafx.modules.core.config.DatabaseFactory$DI;
import com.econovafx.modules.core.config.DatabaseSeeder$DI;
...
import com.econovafx.modules.core.repository.BusinessUnitRepository$DI;
...
import com.econovafx.modules.core.service.BusinessUnitService$DI;
...
import com.econovafx.modules.core.service.NotificationService$DI;
import com.econovafx.modules.core.service.SystemConfigService$DI;
import com.econovafx.modules.core.service.UserService$DI;
import com.econovafx.modules.core.service.backup.BackupSchedulerService$DI;
...
import com.econovafx.modules.core.ui.controller.CompanySelectionController$DI;
import com.econovafx.modules.core.ui.controller.DashboardController$DI;
import com.econovafx.modules.core.ui.controller.ExchangeRatesController$DI;
import com.econovafx.modules.core.ui.controller.MainViewController$DI;
import com.econovafx.modules.core.ui.controller.SystemSettingsController$DI;
import com.econovafx.modules.core.ui.controller.UnitSelectionController$DI;
import com.econovafx.modules.core.ui.controller.WebViewController$DI;
import com.econovafx.modules.core.ui.web.LocalWebServer$DI;
import com.econovafx.modules.fixedassets.controller.FixedAssetController$DI;
...
import com.econovafx.modules.inventory.service.InventoryReportService$DI;
import com.econovafx.modules.inventory.service.InventoryService$DI;
import com.econovafx.modules.payables.repository.SupplierInvoiceRepository$DI;
import com.econovafx.modules.payables.repository.SupplierPaymentRepository$DI;
import com.econovafx.modules.payables.service.PayablesService$DI;
import com.econovafx.modules.payroll.repository.EmployeeRepository$DI;
import com.econovafx.modules.payroll.repository.PayrollConceptRepository$DI;
import com.econovafx.modules.payroll.service.PayrollService$DI;
import com.econovafx.modules.receivables.repository.CustomerInvoiceRepository$DI;
import com.econovafx.modules.receivables.repository.CustomerPaymentRepository$DI;
import com.econovafx.modules.receivables.service.ReceivablesService$DI;
import com.econovafx.modules.reporting.controller.FinancialReportingController$DI;
import com.econovafx.modules.reporting.repository.FinancialReportRepository$DI;
import com.econovafx.modules.reporting.service.FinancialReportingService$DI;
import com.econovafx.modules.reporting.service.consolidation.ConsolidationService$DI;
import com.econovafx.modules.security.ui.controller.LoginController$DI;
...
public final class EconovafxModule implements AvajeModule {
  ...
  public void build(Builder builder) {
    ...
    build_repository_ClosingEntryRepository(builder);
    build_service_AccountingPeriodService(builder);
    build_config_AppConfig(builder);
    build_config_DataInitializer(builder);
    build_config_DatabaseConfig(builder);
    ...
    build_service_BusinessUnitService(builder);
    ...
    build_controller_CompanySelectionController(builder);
    build_controller_ExchangeRatesController(builder);
    build_controller_SystemSettingsController(builder);
    build_controller_UnitSelectionController(builder);
    build_web_LocalWebServer(builder);
    build_controller_FixedAssetController(builder);
    build_service_InventoryReportService(builder);
    build_service_InventoryService(builder);
    build_service_PayrollService(builder);
    build_controller_FinancialReportingController(builder);
    build_controller_WebViewController(builder);
    ...
    build_repository_BankAccountRepository(builder);
    build_repository_BankReconciliationRepository(builder);
    ...
    build_repository_CashBoxRepository(builder);
    build_repository_CashMovementRepository(builder);
    build_service_CashMovementService(builder);
    build_config_DatabaseSeeder(builder);
    build_repository_AuditLogRepository(builder);
    build_repository_BusinessUnitRepository(builder);
    ...
    build_backup_BackupSchedulerService(builder);
    ...
    build_repository_SupplierInvoiceRepository(builder);
    build_repository_SupplierPaymentRepository(builder);
    build_repository_EmployeeRepository(builder);
    build_repository_PayrollConceptRepository(builder);
    build_repository_CustomerInvoiceRepository(builder);
    build_repository_CustomerPaymentRepository(builder);
    build_repository_FinancialReportRepository(builder);
    build_service_FinancialReportingService(builder);
    build_service_TransactionService(builder);
    build_service_BillingService(builder);
    build_controller_CashBankController(builder);
    build_controller_CashModuleController(builder);
    build_security_AuthService(builder);
    build_service_ExchangeRateScheduler(builder);
    build_controller_DashboardController(builder);
    build_controller_MainViewController(builder);
    build_service_DepreciationService(builder);
    build_service_ReceivablesService(builder);
    build_controller_LoginController(builder);
    build_service_ExchangeDifferenceService(builder);
    build_service_ExchangeRevaluationService(builder);
    build_service_IntercompanyEliminationService(builder);
    build_service_OpeningBalanceService(builder);
    build_service_PayablesService(builder);
    build_consolidation_ConsolidationService(builder);
  }
  ...
  public String[] providesBeans() {
    return new String[] {
      ...
      "com.econovafx.modules.accounting.repository.ClosingEntryRepository",
      ...
      "com.econovafx.modules.accounting.service.ExchangeRevaluationService",
      "com.econovafx.modules.accounting.service.FinancialStatementService",
      "com.econovafx.modules.accounting.service.IntercompanyEliminationService",
      "com.econovafx.modules.accounting.service.OpeningBalanceService",
      "com.econovafx.modules.accounting.service.TransactionService",
      "com.econovafx.modules.bank.repository.BankAccountRepository",
      "com.econovafx.modules.bank.repository.BankReconciliationRepository",
      ...
      "com.econovafx.modules.cash.controller.CashBankController",
      "com.econovafx.modules.cash.controller.CashModuleController",
      "com.econovafx.modules.cash.repository.CashBoxRepository",
      "com.econovafx.modules.cash.repository.CashMovementRepository",
      "com.econovafx.modules.cash.service.CashMovementService",
      "com.econovafx.modules.core.config.AppConfig",
      "com.econovafx.modules.core.config.DataInitializer",
      "com.econovafx.modules.core.config.DatabaseConfig",
      "com.econovafx.modules.core.config.DatabaseSeeder",
      "com.econovafx.modules.core.config.UserContext",
      "com.econovafx.modules.core.repository.AuditLogRepository",
      "com.econovafx.modules.core.repository.BusinessUnitRepository",
      ...
      "com.econovafx.modules.core.service.BusinessUnitService",
      ...
      "com.econovafx.modules.core.service.NotificationService",
      "com.econovafx.modules.core.service.SystemConfigService",
      "com.econovafx.modules.core.service.UserService",
      "com.econovafx.modules.core.service.backup.BackupSchedulerService",
      ...
      "com.econovafx.modules.core.ui.controller.CompanySelectionController",
      "com.econovafx.modules.core.ui.controller.DashboardController",
      "com.econovafx.modules.core.ui.controller.ExchangeRatesController",
      "com.econovafx.modules.core.ui.controller.MainViewController",
      "com.econovafx.modules.core.ui.controller.SystemSettingsController",
      "com.econovafx.modules.core.ui.controller.UnitSelectionController",
      "com.econovafx.modules.core.ui.controller.WebViewController",
      "com.econovafx.modules.core.ui.web.LocalWebServer",
      "com.econovafx.modules.fixedassets.controller.FixedAssetController",
      ...
      "com.econovafx.modules.inventory.service.InventoryReportService",
      "com.econovafx.modules.inventory.service.InventoryService",
      "com.econovafx.modules.payables.repository.SupplierInvoiceRepository",
      "com.econovafx.modules.payables.repository.SupplierPaymentRepository",
      "com.econovafx.modules.payables.service.PayablesService",
      "com.econovafx.modules.payroll.repository.EmployeeRepository",
      "com.econovafx.modules.payroll.repository.PayrollConceptRepository",
      "com.econovafx.modules.payroll.service.PayrollService",
      "com.econovafx.modules.receivables.repository.CustomerInvoiceRepository",
      "com.econovafx.modules.receivables.repository.CustomerPaymentRepository",
      "com.econovafx.modules.receivables.service.ReceivablesService",
      "com.econovafx.modules.reporting.controller.FinancialReportingController",
      "com.econovafx.modules.reporting.repository.FinancialReportRepository",
      "com.econovafx.modules.reporting.service.FinancialReportingService",
      "com.econovafx.modules.reporting.service.consolidation.ConsolidationService",
      "com.econovafx.modules.security.ui.controller.LoginController",
  ...
  public Class<?>[] classes() {
    return new Class<?>[] {
      ...
      com.econovafx.modules.accounting.repository.ClosingEntryRepository.class,
      ...
      com.econovafx.modules.accounting.service.ExchangeRevaluationService.class,
      com.econovafx.modules.accounting.service.FinancialStatementService.class,
      com.econovafx.modules.accounting.service.IntercompanyEliminationService.class,
      com.econovafx.modules.accounting.service.OpeningBalanceService.class,
      com.econovafx.modules.accounting.service.TransactionService.class,
      com.econovafx.modules.bank.repository.BankAccountRepository.class,
      com.econovafx.modules.bank.repository.BankReconciliationRepository.class,
      ...
      com.econovafx.modules.cash.controller.CashBankController.class,
      com.econovafx.modules.cash.controller.CashModuleController.class,
      com.econovafx.modules.cash.repository.CashBoxRepository.class,
      com.econovafx.modules.cash.repository.CashMovementRepository.class,
      com.econovafx.modules.cash.service.CashMovementService.class,
      com.econovafx.modules.core.config.AppConfig.class,
      com.econovafx.modules.core.config.DataInitializer.class,
      com.econovafx.modules.core.config.DatabaseConfig.class,
      com.econovafx.modules.core.config.DatabaseFactory.class,
      com.econovafx.modules.core.config.DatabaseSeeder.class,
      ...
      com.econovafx.modules.core.repository.BusinessUnitRepository.class,
      ...
      com.econovafx.modules.core.service.BusinessUnitService.class,
      ...
      com.econovafx.modules.core.service.NotificationService.class,
      com.econovafx.modules.core.service.SystemConfigService.class,
      com.econovafx.modules.core.service.UserService.class,
      com.econovafx.modules.core.service.backup.BackupSchedulerService.class,
      ...
      com.econovafx.modules.core.ui.controller.CompanySelectionController.class,
      com.econovafx.modules.core.ui.controller.DashboardController.class,
      com.econovafx.modules.core.ui.controller.ExchangeRatesController.class,
      com.econovafx.modules.core.ui.controller.MainViewController.class,
      com.econovafx.modules.core.ui.controller.SystemSettingsController.class,
      com.econovafx.modules.core.ui.controller.UnitSelectionController.class,
      com.econovafx.modules.core.ui.controller.WebViewController.class,
      com.econovafx.modules.core.ui.web.LocalWebServer.class,
      com.econovafx.modules.fixedassets.controller.FixedAssetController.class,
      ...
      com.econovafx.modules.inventory.service.InventoryReportService.class,
      com.econovafx.modules.inventory.service.InventoryService.class,
      com.econovafx.modules.payables.repository.SupplierInvoiceRepository.class,
      com.econovafx.modules.payables.repository.SupplierPaymentRepository.class,
      com.econovafx.modules.payables.service.PayablesService.class,
      com.econovafx.modules.payroll.repository.EmployeeRepository.class,
      com.econovafx.modules.payroll.repository.PayrollConceptRepository.class,
      com.econovafx.modules.payroll.service.PayrollService.class,
      com.econovafx.modules.receivables.repository.CustomerInvoiceRepository.class,
      com.econovafx.modules.receivables.repository.CustomerPaymentRepository.class,
      com.econovafx.modules.receivables.service.ReceivablesService.class,
      com.econovafx.modules.reporting.controller.FinancialReportingController.class,
      com.econovafx.modules.reporting.repository.FinancialReportRepository.class,
      com.econovafx.modules.reporting.service.FinancialReportingService.class,
      com.econovafx.modules.reporting.service.consolidation.ConsolidationService.class,
      com.econovafx.modules.security.ui.controller.LoginController.class,
  ...
  @DependencyMeta(
      type = "com.econovafx.modules.accounting.repository.ClosingEntryRepository",
      provides = {"com.econovafx.modules.accounting.repository.ClosingEntryRepository"})
  public static void build_repository_ClosingEntryRepository(Builder builder) {
    ClosingEntryRepository$DI.build(builder);
  }
  ...
  @DependencyMeta(
      type = "com.econovafx.modules.core.config.AppConfig",
      provides = {"com.econovafx.modules.core.config.AppConfig"})
  public static void build_config_AppConfig(Builder builder) {
    AppConfig$DI.build(builder);
  }
  ...
  @DependencyMeta(
      type = "com.econovafx.modules.core.config.DatabaseConfig",
      provides = {"com.econovafx.modules.core.config.DatabaseConfig"})
  public static void build_config_DatabaseConfig(Builder builder) {
    DatabaseConfig$DI.build(builder);
  }
  ...
  @DependencyMeta(
      type = "com.econovafx.modules.core.service.BusinessUnitService",
      provides = {"com.econovafx.modules.core.service.BusinessUnitService"})
  public static void build_service_BusinessUnitService(Builder builder) {
    BusinessUnitService$DI.build(builder);
  }
  ...
  @DependencyMeta(
      type = "com.econovafx.modules.core.service.NotificationService",
      provides = {"com.econovafx.modules.core.service.NotificationService"})
  ...
  @DependencyMeta(
      type = "com.econovafx.modules.core.ui.controller.CompanySelectionController",
      provides = {"com.econovafx.modules.core.ui.controller.CompanySelectionController"})
  public static void build_controller_CompanySelectionController(Builder builder) {
    CompanySelectionController$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.core.ui.controller.ExchangeRatesController",
      provides = {"com.econovafx.modules.core.ui.controller.ExchangeRatesController"})
  public static void build_controller_ExchangeRatesController(Builder builder) {
    ExchangeRatesController$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.core.ui.controller.SystemSettingsController",
      provides = {"com.econovafx.modules.core.ui.controller.SystemSettingsController"})
  public static void build_controller_SystemSettingsController(Builder builder) {
    SystemSettingsController$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.core.ui.controller.UnitSelectionController",
      provides = {"com.econovafx.modules.core.ui.controller.UnitSelectionController"})
  public static void build_controller_UnitSelectionController(Builder builder) {
    UnitSelectionController$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.core.ui.web.LocalWebServer",
      provides = {"com.econovafx.modules.core.ui.web.LocalWebServer"})
  public static void build_web_LocalWebServer(Builder builder) {
    LocalWebServer$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.fixedassets.controller.FixedAssetController",
      provides = {"com.econovafx.modules.fixedassets.controller.FixedAssetController"})
  public static void build_controller_FixedAssetController(Builder builder) {
    FixedAssetController$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.inventory.service.InventoryReportService",
      provides = {"com.econovafx.modules.inventory.service.InventoryReportService"})
  public static void build_service_InventoryReportService(Builder builder) {
    InventoryReportService$DI.build(builder);
  }
  ...
  @DependencyMeta(
      type = "com.econovafx.modules.payroll.service.PayrollService",
      provides = {"com.econovafx.modules.payroll.service.PayrollService"})
  public static void build_service_PayrollService(Builder builder) {
    PayrollService$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.reporting.controller.FinancialReportingController",
      provides = {"com.econovafx.modules.reporting.controller.FinancialReportingController"})
  public static void build_controller_FinancialReportingController(Builder builder) {
    FinancialReportingController$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.core.ui.controller.WebViewController",
      provides = {
        "javafx.fxml.Initializable",
        "com.econovafx.modules.core.ui.controller.WebViewController"
      },
      dependsOn = {"com.econovafx.modules.core.ui.web.LocalWebServer"})
  public static void build_controller_WebViewController(Builder builder) {
    WebViewController$DI.build(builder);
  }
  ...
  @DependencyMeta(
      type = "com.econovafx.modules.bank.repository.BankAccountRepository",
      provides = {"com.econovafx.modules.bank.repository.BankAccountRepository"},
      dependsOn = {"io.ebean.Database"})
  public static void build_repository_BankAccountRepository(Builder builder) {
    BankAccountRepository$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.bank.repository.BankReconciliationRepository",
      provides = {"com.econovafx.modules.bank.repository.BankReconciliationRepository"},
      dependsOn = {"io.ebean.Database"})
  public static void build_repository_BankReconciliationRepository(Builder builder) {
    BankReconciliationRepository$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.bank.service.BankAccountService",
      provides = {"com.econovafx.modules.bank.service.BankAccountService"},
      dependsOn = {"com.econovafx.modules.bank.repository.BankAccountRepository"})
  ...
  @DependencyMeta(
      ...
      dependsOn = {"com.econovafx.modules.bank.repository.BankReconciliationRepository"})
  ...
  @DependencyMeta(
      type = "com.econovafx.modules.cash.repository.CashBoxRepository",
      provides = {"com.econovafx.modules.cash.repository.CashBoxRepository"},
      dependsOn = {"io.ebean.Database"})
  public static void build_repository_CashBoxRepository(Builder builder) {
    CashBoxRepository$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.cash.repository.CashMovementRepository",
      provides = {"com.econovafx.modules.cash.repository.CashMovementRepository"},
      dependsOn = {"io.ebean.Database"})
  public static void build_repository_CashMovementRepository(Builder builder) {
    CashMovementRepository$DI.build(builder);
  }
  ...
  @DependencyMeta(
      type = "com.econovafx.modules.core.config.DatabaseSeeder",
      provides = {"com.econovafx.modules.core.config.DatabaseSeeder"},
      dependsOn = {"io.ebean.Database"})
  public static void build_config_DatabaseSeeder(Builder builder) {
    DatabaseSeeder$DI.build(builder);
  }
  ...
  @DependencyMeta(
      type = "com.econovafx.modules.core.repository.BusinessUnitRepository",
      provides = {"com.econovafx.modules.core.repository.BusinessUnitRepository"},
      dependsOn = {"io.ebean.Database"})
  public static void build_repository_BusinessUnitRepository(Builder builder) {
    BusinessUnitRepository$DI.build(builder);
  }
  ...
  @DependencyMeta(
      ...
      dependsOn = {"com.econovafx.modules.core.repository.CompanyRepository"})
  ...
  @DependencyMeta(
      type = "com.econovafx.modules.core.service.backup.BackupSchedulerService",
      provides = {"com.econovafx.modules.core.service.backup.BackupSchedulerService"},
      dependsOn = {
        "com.econovafx.modules.core.service.SystemConfigService",
        "com.econovafx.modules.core.service.backup.TenantBackupService",
        "com.econovafx.modules.core.service.CompanyService"
      })
  public static void build_backup_BackupSchedulerService(Builder builder) {
    BackupSchedulerService$DI.build(builder);
  }
  ...
  @DependencyMeta(
      type = "com.econovafx.modules.payables.repository.SupplierInvoiceRepository",
      provides = {"com.econovafx.modules.payables.repository.SupplierInvoiceRepository"},
      dependsOn = {"io.ebean.Database"})
  public static void build_repository_SupplierInvoiceRepository(Builder builder) {
    SupplierInvoiceRepository$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.payables.repository.SupplierPaymentRepository",
      provides = {"com.econovafx.modules.payables.repository.SupplierPaymentRepository"},
      dependsOn = {"io.ebean.Database"})
  public static void build_repository_SupplierPaymentRepository(Builder builder) {
    SupplierPaymentRepository$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.payroll.repository.EmployeeRepository",
      provides = {"com.econovafx.modules.payroll.repository.EmployeeRepository"},
      dependsOn = {"io.ebean.Database"})
  public static void build_repository_EmployeeRepository(Builder builder) {
    EmployeeRepository$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.payroll.repository.PayrollConceptRepository",
      provides = {"com.econovafx.modules.payroll.repository.PayrollConceptRepository"},
      dependsOn = {"io.ebean.Database"})
  public static void build_repository_PayrollConceptRepository(Builder builder) {
    PayrollConceptRepository$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.receivables.repository.CustomerInvoiceRepository",
      provides = {"com.econovafx.modules.receivables.repository.CustomerInvoiceRepository"},
      dependsOn = {"io.ebean.Database"})
  public static void build_repository_CustomerInvoiceRepository(Builder builder) {
    CustomerInvoiceRepository$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.receivables.repository.CustomerPaymentRepository",
      provides = {"com.econovafx.modules.receivables.repository.CustomerPaymentRepository"},
      dependsOn = {"io.ebean.Database"})
  public static void build_repository_CustomerPaymentRepository(Builder builder) {
    CustomerPaymentRepository$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.reporting.repository.FinancialReportRepository",
      provides = {"com.econovafx.modules.reporting.repository.FinancialReportRepository"},
      dependsOn = {"io.ebean.Database"})
  public static void build_repository_FinancialReportRepository(Builder builder) {
    FinancialReportRepository$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.reporting.service.FinancialReportingService",
      provides = {"com.econovafx.modules.reporting.service.FinancialReportingService"},
      dependsOn = {
        "com.econovafx.modules.reporting.repository.FinancialReportRepository",
        "com.econovafx.modules.accounting.repository.AccountRepository",
        "com.econovafx.modules.accounting.repository.TransactionRepository"
      })
  public static void build_service_FinancialReportingService(Builder builder) {
    FinancialReportingService$DI.build(builder);
  }
  ...
  @DependencyMeta(
      type = "com.econovafx.modules.cash.controller.CashBankController",
      provides = {"com.econovafx.modules.cash.controller.CashBankController"},
      dependsOn = {
        "com.econovafx.modules.cash.service.CashMovementService",
        "com.econovafx.modules.bank.repository.BankAccountRepository",
        "com.econovafx.modules.cash.repository.CashBoxRepository",
  ...
  public static void build_controller_CashBankController(Builder builder) {
    CashBankController$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.cash.controller.CashModuleController",
      provides = {"com.econovafx.modules.cash.controller.CashModuleController"},
      dependsOn = {
        "com.econovafx.modules.bank.repository.BankAccountRepository",
        "com.econovafx.modules.cash.repository.CashBoxRepository",
        "com.econovafx.modules.cash.repository.CashMovementRepository",
  ...
  public static void build_controller_CashModuleController(Builder builder) {
    CashModuleController$DI.build(builder);
  }
  ...
  @DependencyMeta(
      type = "com.econovafx.modules.core.ui.controller.DashboardController",
      provides = {
        "javafx.fxml.Initializable",
        "com.econovafx.modules.core.ui.controller.DashboardController"
      },
  ...
  public static void build_controller_DashboardController(Builder builder) {
    DashboardController$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.core.ui.controller.MainViewController",
      provides = {
        "javafx.fxml.Initializable",
        "com.econovafx.modules.core.ui.controller.MainViewController"
      },
  ...
  public static void build_controller_MainViewController(Builder builder) {
    MainViewController$DI.build(builder);
  }
  ...
  @DependencyMeta(
      type = "com.econovafx.modules.receivables.service.ReceivablesService",
      provides = {"com.econovafx.modules.receivables.service.ReceivablesService"},
      dependsOn = {
        "com.econovafx.modules.receivables.repository.CustomerInvoiceRepository",
        "com.econovafx.modules.receivables.repository.CustomerPaymentRepository",
        "com.econovafx.modules.billing.service.ThirdPartyService",
  ...
  public static void build_service_ReceivablesService(Builder builder) {
    ReceivablesService$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.security.ui.controller.LoginController",
      provides = {"com.econovafx.modules.security.ui.controller.LoginController"},
      dependsOn = {"com.econovafx.modules.core.security.AuthService"})
  public static void build_controller_LoginController(Builder builder) {
    LoginController$DI.build(builder);
  }
  ...
  @DependencyMeta(
      type = "com.econovafx.modules.accounting.service.ExchangeRevaluationService",
      provides = {"com.econovafx.modules.accounting.service.ExchangeRevaluationService"},
      dependsOn = {
        "com.econovafx.modules.accounting.repository.ExchangeDifferenceRepository",
        "com.econovafx.modules.core.repository.ExchangeRateRepository",
        "com.econovafx.modules.accounting.service.TransactionService",
  ...
  public static void build_service_ExchangeRevaluationService(Builder builder) {
    ExchangeRevaluationService$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.accounting.service.IntercompanyEliminationService",
      provides = {"com.econovafx.modules.accounting.service.IntercompanyEliminationService"},
      dependsOn = {
        "com.econovafx.modules.accounting.repository.TransactionRepository",
        "com.econovafx.modules.accounting.service.TransactionService",
        "com.econovafx.modules.accounting.repository.AccountRepository"
      })
  public static void build_service_IntercompanyEliminationService(Builder builder) {
    IntercompanyEliminationService$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.accounting.service.OpeningBalanceService",
      provides = {"com.econovafx.modules.accounting.service.OpeningBalanceService"},
      dependsOn = {
        "com.econovafx.modules.accounting.repository.TransactionRepository",
        "com.econovafx.modules.accounting.repository.AccountRepository",
        "com.econovafx.modules.accounting.service.TransactionService",
  ...
  public static void build_service_OpeningBalanceService(Builder builder) {
    OpeningBalanceService$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.payables.service.PayablesService",
      provides = {"com.econovafx.modules.payables.service.PayablesService"},
      dependsOn = {
        "com.econovafx.modules.payables.repository.SupplierInvoiceRepository",
        "com.econovafx.modules.payables.repository.SupplierPaymentRepository",
        "com.econovafx.modules.billing.service.ThirdPartyService",
  ...
  public static void build_service_PayablesService(Builder builder) {
    PayablesService$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.modules.reporting.service.consolidation.ConsolidationService",
      provides = {"com.econovafx.modules.reporting.service.consolidation.ConsolidationService"},
      dependsOn = {
        "com.econovafx.modules.core.service.CompanyService",
        "com.econovafx.modules.accounting.service.FinancialStatementService",
        "com.econovafx.modules.accounting.service.IntercompanyEliminationService"
      })
  public static void build_consolidation_ConsolidationService(Builder builder) {
    ConsolidationService$DI.build(builder);
  }
