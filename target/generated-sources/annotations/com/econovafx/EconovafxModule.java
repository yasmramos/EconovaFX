...
import com.econovafx.config.DataInitializer$DI;
...
import com.econovafx.security.AuthService$DI;
import com.econovafx.security.PasswordService$DI;
...
public final class EconovafxModule implements AvajeModule {
  ...
  public String[] providesBeans() {
    return new String[] {
      "com.econovafx.config.DataInitializer",
      ...
      "com.econovafx.security.AuthService",
      "com.econovafx.security.PasswordService",
  ...
  public Class<?>[] classes() {
    return new Class<?>[] {
      com.econovafx.config.DataInitializer.class,
      ...
      com.econovafx.security.AuthService.class,
      com.econovafx.security.PasswordService.class,
  ...
  @DependencyMeta(
      type = "com.econovafx.config.DataInitializer",
      provides = {"com.econovafx.config.DataInitializer"})
  ...
  @DependencyMeta(
      type = "com.econovafx.security.AuthService",
      provides = {"com.econovafx.security.AuthService"})
  public static void build_security_AuthService(Builder builder) {
    AuthService$DI.build(builder);
  }

  @DependencyMeta(
      type = "com.econovafx.security.PasswordService",
      provides = {"com.econovafx.security.PasswordService"})
