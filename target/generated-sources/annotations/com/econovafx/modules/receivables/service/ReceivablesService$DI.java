...
public final class ReceivablesService$DI  {
  ...
  public static void build(Builder builder) {
    if (builder.isBeanAbsent(ReceivablesService.class)) {
      var bean = new ReceivablesService(builder.get(CustomerInvoiceRepository.class,"!invoiceRepository"), builder.get(CustomerPaymentRepository.class,"!paymentRepository"), builder.get(ThirdPartyService.class,"!thirdPartyService"), builder.get(TransactionService.class,"!transactionService"), builder.get(UserContext.class,"!userContext"), builder.get(AccountRepository.class,"!accountRepository"), builder.get(SystemConfigService.class,"!systemConfigService"));
