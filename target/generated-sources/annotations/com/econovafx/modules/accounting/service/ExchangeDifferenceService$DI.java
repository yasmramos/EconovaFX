...
public final class ExchangeDifferenceService$DI  {
  ...
  public static void build(Builder builder) {
    if (builder.isBeanAbsent(ExchangeDifferenceService.class)) {
      var bean = new ExchangeDifferenceService(builder.get(ExchangeDifferenceRepository.class,"!exchangeDifferenceRepository"), builder.get(ExchangeRateRepository.class,"!exchangeRateRepository"), builder.get(TransactionService.class,"!transactionService"), builder.get(AccountRepository.class,"!accountRepository"), builder.get(AuditService.class,"!auditService"), builder.get(SystemConfigService.class,"!systemConfigService"));
