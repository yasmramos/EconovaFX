...
public final class FinancialStatementService$DI  {
  ...
  public static void build(Builder builder) {
    if (builder.isBeanAbsent(FinancialStatementService.class)) {
      var bean = new FinancialStatementService(builder.get(FinancialStatementModelRepository.class,"!modelRepository"), builder.get(FinancialStatementRowRepository.class,"!rowRepository"), builder.get(AccountRepository.class,"!accountRepository"), builder.get(TransactionRepository.class,"!transactionRepository"));
