...
public final class TransactionService$DI  {
  ...
  public static void build(Builder builder) {
    if (builder.isBeanAbsent(TransactionService.class)) {
      var bean = new TransactionService(builder.get(TransactionRepository.class,"!transactionRepository"), builder.get(AccountRepository.class,"!accountRepository"), builder.get(AuditService.class,"!auditService"), builder.get(AccountingPeriodService.class,"!accountingPeriodService"), builder.get(ClosingEntryRepository.class,"!closingEntryRepository"));
