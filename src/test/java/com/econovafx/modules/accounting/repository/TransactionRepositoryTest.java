...
class TransactionRepositoryTest {
    ...
    private com.econovafx.modules.accounting.model.Transaction createTestTransaction(String number, Account account) {
    ...
    void testSave_Success() {
        ...
        com.econovafx.modules.accounting.model.Transaction transaction = createTestTransaction("TRX-001", account);
    ...
    void testFindById_Exists() {
        ...
        com.econovafx.modules.accounting.model.Transaction transaction = createTestTransaction("TRX-002", account);
        transactionRepository.save(transaction);
    ...
    void testFindAll() {
        ...
        // Act
        List<com.econovafx.modules.accounting.model.Transaction> transactions = transactionRepository.findAll();
    ...
    void testDelete_Success() {
        ...
        com.econovafx.modules.accounting.model.Transaction transaction = createTestTransaction("TRX-005", account);
        transactionRepository.save(transaction);
    ...
    void testFindByType() {
        ...
        com.econovafx.modules.accounting.model.Transaction t1 = createTestTransaction("TRX-TYPE-1", account);
        t1.setType("INCOME");
        com.econovafx.modules.accounting.model.Transaction t2 = createTestTransaction("TRX-TYPE-2", account);
        t2.setType("EXPENSE");
        com.econovafx.modules.accounting.model.Transaction t3 = createTestTransaction("TRX-TYPE-3", account);
        t3.setType("INCOME");
        ...
        // Act
        List<com.econovafx.modules.accounting.model.Transaction> incomeTransactions = transactionRepository.findByType("INCOME");
    ...
    void testFindByDateRange() {
        ...
        com.econovafx.modules.accounting.model.Transaction t1 = createTestTransaction("TRX-DATE-1", account);
        t1.setDate(startDate);
        com.econovafx.modules.accounting.model.Transaction t2 = createTestTransaction("TRX-DATE-2", account);
        t2.setDate(LocalDate.now());
        com.econovafx.modules.accounting.model.Transaction t3 = createTestTransaction("TRX-DATE-3", account);
        t3.setDate(endDate);
        ...
        // Act
        List<com.econovafx.modules.accounting.model.Transaction> result = transactionRepository.findByDateRange(startDate, endDate);
    ...
    void testSearchByDescription() {
        ...
        com.econovafx.modules.accounting.model.Transaction t1 = createTestTransaction("TRX-016", account);
        t1.setDescription("Payment for services");
        com.econovafx.modules.accounting.model.Transaction t2 = createTestTransaction("TRX-017", account);
        t2.setDescription("Office supplies purchase");
        com.econovafx.modules.accounting.model.Transaction t3 = createTestTransaction("TRX-018", account);
        ...
        // Act
        List<com.econovafx.modules.accounting.model.Transaction> result = transactionRepository.searchByDescription("payment");
    ...
    void testFindByThirdParty() {
        ...
        com.econovafx.modules.accounting.model.Transaction t1 = createTestTransaction("TRX-019", account1);
        t1.setThirdParty(thirdParty);
        com.econovafx.modules.accounting.model.Transaction t2 = createTestTransaction("TRX-020", account1);
        t2.setThirdParty(thirdParty);
        com.econovafx.modules.accounting.model.Transaction t3 = createTestTransaction("TRX-021", account1);
        t3.setThirdParty(thirdParty);
        com.econovafx.modules.accounting.model.Transaction t4 = createTestTransaction("TRX-022", account2);
        ...
        // Act
        List<com.econovafx.modules.accounting.model.Transaction> result = transactionRepository.findByThirdPartyId(thirdParty.getId());
