...
public class ExchangeDifference extends BaseEntity {
    ...
    private Long documentId; // ID of the original invoice

    @Column(nullable = false)
    private String documentNumber; // Number of the original invoice
    ...
    private Long journalEntryId; // Reference to the accounting entry generated by the difference

    /**
     * Indicates if this exchange difference is unrealized (from revaluation at period end)
     * or realized (from actual payment).
     */
    @Column(name = "is_unrealized", nullable = false)
    private boolean unrealized = false;
    ...
    public boolean isUnrealized() { return unrealized; }
    public void setUnrealized(boolean unrealized) { this.unrealized = unrealized; }

    public String getNotes() { return notes; }
    public void setNotes(String notes) { this.notes = notes; }

    public enum DifferenceType {
        GAIN,           // Ganancia cambiaria realizada
        LOSS,           // Pérdida cambiaria realizada
        NONE,           // Sin diferencia
        UNREALIZED_GAIN,  // Ganancia cambiaria no realizada (revaluación)
        UNREALIZED_LOSS   // Pérdida cambiaria no realizada (revaluación)
    }
}
