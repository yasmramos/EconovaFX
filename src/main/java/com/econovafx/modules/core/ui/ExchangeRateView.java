...
public class ExchangeRateView extends VBox {
    ...
    private Tab createActiveRatesTab() {
        ...
        refreshButton.setGraphic(new FontIcon(MaterialDesign.REFRESH));
    ...
    private Tab createHistoryTab() {
        ...
        searchButton.setGraphic(new FontIcon(MaterialDesign.SEARCH));
        searchButton.setText(" Buscar");
        searchButton.setOnAction(e -> handleSearchHistory());

        exportButton = new Button();
        exportButton.setGraphic(new FontIcon(MaterialDesign.DOWNLOAD));
